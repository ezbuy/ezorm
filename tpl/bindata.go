...
func tplMssql_configGogo() (*asset, error) {
	...
	info := bindataFileInfo{name: "tpl/mssql_config.gogo", size: 1955, mode: os.FileMode(420), modTime: time.Unix(1473403616, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func tplMssql_ormGogo() (*asset, error) {
	...
	info := bindataFileInfo{name: "tpl/mssql_orm.gogo", size: 7798, mode: os.FileMode(420), modTime: time.Unix(1473393391, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
