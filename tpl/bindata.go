...
func tplMssql_ormGogo() (*asset, error) {
	...
	info := bindataFileInfo{name: "tpl/mssql_orm.gogo", size: 7238, mode: os.FileMode(420), modTime: time.Unix(1463456893, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func tplStructGogo() (*asset, error) {
	...
	info := bindataFileInfo{name: "tpl/struct.gogo", size: 1165, mode: os.FileMode(420), modTime: time.Unix(1462503351, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
