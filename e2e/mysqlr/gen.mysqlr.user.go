...
func (m *_UserDBMgr) FetchByPrimaryKey(ctx context.Context, _id int64, _userId int32) (*User, error) {
	obj := UserMgr.NewUser()
	pk := &IdUserIdOfUserPK{
		Id:     _id,
		UserId: _userId,
...
func (m *_UserDBMgr) DeleteByPrimaryKey(ctx context.Context, _id int64, _userId int32) (int64, error) {
	pk := &IdUserIdOfUserPK{
		Id:     _id,
		UserId: _userId,
	}
